...
def move(pos):
    if pos.top:
        ...
        robot1.backward(pos.distance)
        robot2.backward(pos.distance)
        robot3.backward(pos.distance)
        print("down on"+str(pos.distance))
    elif pos.right:
        robot1.right(pos.distance)
        robot2.right(pos.distance)
        robot3.right(pos.distance)
        print("right on"+str(pos.distance))
    elif pos.left:
        robot1.left(pos.distance)
        robot2.left(pos.distance)
        robot3.left(pos.distance)
